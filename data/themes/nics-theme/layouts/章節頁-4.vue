...
<template>
  <div class="slidev-layout nics-章節頁-4" :class="props.layoutClass">
    <!-- 背景圖片 1 -->
    <div 
      class="bg-image-1" 
      :style="{ backgroundImage: `url(${props.bgImage1 || '/layout-10-image-1.png'})` }"
    />
    <!-- 背景圖片 2 -->
    <div 
      class="bg-image-2" 
      :style="{ backgroundImage: `url(${props.bgImage2 || '/layout-10-image-2.png'})` }"
    />
